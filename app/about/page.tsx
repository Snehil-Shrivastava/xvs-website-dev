    ...
    <>
      <div className="relative">
        ...
        >
          ...
          >
            <foreignObject x="-30" y="-10" width="296.6" height="297">
              <div
                ...
                style={{
                  ...
                  clipPath: "url(#bgblur_0_3273_1647_clip_path)",
                  height: "100%",
                  width: "100%",
                }}
              ></div>
            ...
            <g
              filter="url(#filter0_d_3273_1647)"
            ...
            >
              ...
              <path
                ref={bigLambda1Ref}
                d="M0 20L67.8368 138.598L0 257H67.6392L102.004 197.625L136.369 257H204L67.6392 20H0Z"
                fill="#F79839"
                fillOpacity="0.3"
              ...
              <path
                ref={bigLambda2Ref}
                d="M67.4951 20.25L203.567 256.75H136.514L102.221 197.499L102.004 197.126L101.788 197.499L67.4951 256.75H0.430664L68.0537 138.722L68.125 138.598L68.0537 138.474L0.430664 20.25H67.4951Z"
                stroke="url(#paint0_linear_3273_1647)"
                strokeWidth="0.5"
                shapeRendering="crispEdges"
              />
            </g>
            <foreignObject x="-30" y="-10" width="296.6" height="297">
              <div
                ...
                style={{
                  backdropFilter: "blur(15px)",
                  clipPath: "url(#bgblur_1_3273_1647_clip_path)",
                  height: "100%",
                  width: "100%",
                }}
              ></div>
            ...
            <g
              filter="url(#filter1_d_3273_1647)"
              data-figma-bg-blur-radius="30"
            >
              <path
                ref={bigLambda3Ref}
                d="M0 20L67.8368 138.598L0 257H67.6392L102.004 197.625L136.369 257H204L67.6392 20H0Z"
                fill="url(#paint1_linear_3273_1647)"
                fillOpacity="0.4"
              ...
              <path
                ref={bigLambda5Ref}
                d="M67.4951 20.25L203.567 256.75H136.514L102.221 197.499L102.004 197.126L101.788 197.499L67.4951 256.75H0.430664L68.0537 138.722L68.125 138.598L68.0537 138.474L0.430664 20.25H67.4951Z"
                stroke="url(#paint2_linear_3273_1647)"
                strokeWidth="0.5"
                shapeRendering="crispEdges"
              />
            </g>
            <defs>
              ...
              >
                ...
                <feBlend
                  ...
                  result="effect1_dropShadow_3273_1647"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
                  in2="effect1_dropShadow_3273_1647"
                  result="shape"
                />
              </filter>
              <clipPath
                id="bgblur_0_3273_1647_clip_path"
                transform="translate(30 10)"
              >
                <path d="M0 20L67.8368 138.598L0 257H67.6392L102.004 197.625L136.369 257H204L67.6392 20H0Z" />
              </clipPath>
              <filter
                id="filter1_d_3273_1647"
                x="-30"
                y="-10"
                width="296.6"
                height="297"
              ...
              <clipPath
                id="bgblur_1_3273_1647_clip_path"
                transform="translate(30 10)"
              >
                <path d="M0 20L67.8368 138.598L0 257H67.6392L102.004 197.625L136.369 257H204L67.6392 20H0Z" />
              </clipPath>
              <linearGradient
                id="paint0_linear_3273_1647"
                x1="220.793"
                y1="138.5"
                x2="-16.7927"
                y2="138.5"
      ...
      >
        {/* <Image
            ...
            alt="xVS"
            className="mx-auto"
            style={{ transform: "translate(40px, 0)", visibility: 'hidden' }}
          /> */}
        ...
        <svg
          ...
          viewBox="0 0 217 172"
          fill="none"
          className="mx-auto max-[426px]:scale-[1] max-[426px]:h-[50px] translate-x-[20px] max-[426px]:translate-x-[5px]"
