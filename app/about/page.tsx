    ...
    <>
      <div className="relative">
        ...
        <h1
          // @ts-ignore
          ref={AboutMainText}
          className="absolute text-center max-sm:top-17.5 sm:max-lg:top-25 left-1/2 -translate-x-1/2 mx-auto text-[#F3EDDE] font-semibold aboutText pointer-events-none max-sm:text-[1.8rem]/[2rem] max-sm:w-4/5 sm:max-lg:w-3/5 sm:max-lg:text-[2.5rem]/[3rem]"
        >
          Inspiration to interpreting reality
        </h1>
        <div
          // id="smooth-wrapper"
          className={`absolute left-1/2 -translate-x-1/2 max-sm:top-40 pointer-events-none max-sm:h-24 max-sm:w-21 sm:max-lg:top-56.5 sm:max-lg:w-29 sm:max-lg:h-33.75`}
        >        
      ...
      >
        ...
        <svg
          ...
          viewBox="0 0 217 172"
          fill="none"
          className="w-auto max-sm:h-20 sm:max-lg:h-35.5 mx-auto scale-[1] translate-x-[5px]"
        >
          <path
        ...
        <p
          // @ts-ignore
          className="font-light text-center w-4/5 mx-auto text-[#F3EDDE] text-[0.5rem]/[1rem] sm:max-lg:text-[1rem]/[2rem] mt-[22px]"
        >
