...
const HoverGlowCardsCarousel = () => {
  ...
  return (
    <div className={styles.bodyContainer}> {/* Added a wrapper for body styles */}
          ...
          <div className={`${styles.card}`}>
            <div className={styles["card-content"]}>
                  ...
                  <div className=' text-center w-[60%] mx-auto pb-[56px] mt-auto flex flex-col gap-[12px]'>
                    ...
                    <p className="font-light text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis, alias molestias!</p>
                  </div>
            </div>
          </div>
      </div>
