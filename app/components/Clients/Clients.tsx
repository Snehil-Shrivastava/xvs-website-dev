...
const Clients = () => {
  ...
  return (
    <div className="py-[98px] mt-[64px] review-box max-[1025px]:py-[64px] max-[769px]:py-[48px] max-[426px]:py-[36px] min-[1906px]:w-7/10 min-[1906px]:mx-auto max-[769px]:w-19/20 max-[769px]:mx-auto">
