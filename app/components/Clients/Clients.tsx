...
const Clients = () => {
  ...
  return (
    <div className="py-[98px] mt-[64px] review-box max-[1025px]:py-[64px] max-[769px]:py-[48px]">
          ...
          <div className="flex mt-[88px] text-left gap-[32px] justify-between max-[1025px]:mt-[44px] max-[769px]:mt-[32px] max-[426px]:gap-[12px]">
            {clientReviews.map((item, index) => (
              <div key={index} className="w-[320px]">
                <h3 className="font-bold tracking-wider max-[1025px]:text-[0.75rem] max-[769px]:text-[0.5rem]">
                  {item.name}
                </h3>
                <p className="text-[#ffffff66] max-[1441px]:text-[0.875rem] max-[1025px]:text-[0.65rem] max-[769px]:text-[0.4rem]">
                  {item.designation}
                </p>
